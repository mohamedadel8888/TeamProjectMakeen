...
public class ReassignEmployee extends BaseComp {
    private WebDriver driver;
    private WebDriverWait exWait;

    public ReassignEmployee(WebDriver driver){
        super(driver);
        this.driver = driver;
    ...
    @FindBy (id = "RadDisActive")  /* راديو بوتن ليسوا على رأس العمل*/
            WebElement radioBtnNotWorking;
    @FindBy (id ="btn_ReCreate")    /*زر اعادة تعيين موظف */
            WebElement reassignEmployee;
    @FindBy (id = "txt_MainOrganizationNumber") /*حقل رقم الموظف */
        WebElement organizationNumberText;
    ...
    public void searchForEmployee (String empNum){
        ...
        organizationNumberText.sendKeys(empNum);
        searchButton.click();
        WebElement selectedEmp = driver.findElement(By.xpath("(//input[@id='cb_transEmps"+empNum+"'])[1]"));
        selectedEmp.click();
    }
    public void enterReassignEmployee () { /*دخول صفحه اعادة تعيين */
        exWait.until(ExpectedConditions.elementToBeClickable(reassignEmployee));
        reassignEmployee.click();
    }
    private By divNewEmployee = By.id("DivNewEmp"); /*صفحه اعادة تعيين موظف*/
    ...
    public void selectMajorJob(String majorJob){
        ...
        exWait.until(ExpectedConditions.elementToBeClickable(ddlMajorJob));
        majorJobAll.click();
    ...
    public WebElement getOrganizationNumber(){
        return driver.findElement(organizationNumber);
    }
    ...
    public void workDateSelect (String day, String month, String year){
        ...
        workDateText1.clear();
        workDateText1.sendKeys(day+"/"+month+"/"+year);
        Actions actions = new Actions(driver);
        actions.moveByOffset(50, 50).click().perform();
    }
    ...
    public void firstJobDateSelect (String day, String month, String year){
        ...
        firstJobDateText1.sendKeys(day+"/"+month+"/"+year);
        Actions actions = new Actions(driver);
        actions.moveByOffset(50, 50).click().perform();
    }
